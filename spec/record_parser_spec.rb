...
describe "RecordParser" do
  describe "::read" do
    it "parses a file of comma-space delimited records and returns an array of arrays" do
    ...
    it "parses a file of pipe delimited records and returns an array of arrays" do
    ...
    it "parses a file of space delimited records and returns an array of arrays" do
