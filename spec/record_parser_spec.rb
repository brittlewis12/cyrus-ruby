...
describe RecordParser do
  describe "::read" do
    ...
    it "takes a custom delimiter as an optional hash argument to parse a CSV recordset" do
    ...
    it "takes a custom Record config (hash of attributes & indices) an an optional hash argument and returns an array of Record objects" do
